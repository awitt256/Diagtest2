...
def render_account_menu():
    ...
    account_frame = ctk.CTkFrame(content_frame, fg_color="transparent")
    account_frame.pack(fill="x", expand=True, pady=20)
    ...
    ctk.CTkButton(
        ...
        width=300,
        height=32,
        command=lambda: run_cmd("start ms-settings:otherusers")
    ).pack(pady=6)
    ...
    ctk.CTkButton(
        ...
        width=300,
        height=32,
        command=lambda: run_tool("deleteaccount.bat")
    ).pack(pady=6)
    ...
    ctk.CTkButton(
        ...
        width=300,
        height=32,
        command=lambda: run_tool("account.bat")
    ).pack(pady=6)
