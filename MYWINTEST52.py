...
def show_hardware_test_screen():
    ...
    wifi_networks_frame = _register_ctk_frame(ctk.CTkFrame(net_content, fg_color=theme_value("embed_bg"), corner_radius=8))
    ...
    try:
        ...
        try:
            _register_refresh_button(ctk.CTkButton(header_row, text="⟳", width=28, height=28, fg_color="#444444", hover_color="#555555", command=lambda: _start_battery_embed())).pack(side="right")
        except Exception:
            pass
    except Exception:
        pass
    ...
    def _start_touchpad_embed():
        ...
        try:
            ...
            if not _os.path.exists(_tp_path):
                ctk.CTkLabel(tp_host, text=f"touchpad_tester_3.py not found: {_tp_path}", text_color="#ff7b72").pack(pady=14)
                return
