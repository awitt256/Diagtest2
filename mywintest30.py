...
def show_hardware_test_screen():
    ...
    ctk.CTkLabel(
        top_bar,
        text="Hardware Test Suite — Revision 0.30: vARIOUS MINOR TWEAKS DONE",
    ...
    try:
        # Reduce touchpad embed height to half
        tp_host.configure(height=210)
    ...
    try:
        ...
        pixel_card.configure(height=210)
