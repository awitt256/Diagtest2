...
echo.
echo                 DIAGNOSTICS TEST TOOL V.64- BUILT BY ANTHONY WITT 2025
timeout /t 3 >nul

:Menu
echo =================================================================================
echo                   DIAGNOSTICS TEST TOOL V.64- BUILT BY ANTHONY WITT
echo ================================================================================
...
if "%perfchoice%"=="3" goto RunPerformanceTest
if "%perfchoice%"=="4" goto Menu
