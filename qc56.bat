...
echo.
echo                 DIAGNOSTICS TEST TOOL V.56  - BUILT BY ANTHONY WITT 2025
timeout /t 3 >nul
...
echo  22. Touchscreen Test       23. Webcam Quality Test    24. SSD Test
echo.
echo [ NETWORK ]
...
echo  33. Windows Defender      34. Windows Update         35. Check Windows Key
echo  36. Windows Version
echo.
...
if "%choice%"=="34" goto WindowsUpdate
if "%choice%"=="35" goto WinKey
if "%choice%"=="36" goto WindowsVersion
...
if "%stresschoice%"=="7" (
    echo.
    echo Starting OCCT...
    echo This will run extended stress tests
    echo 
    echo.
    pause
    echo Running OCCT stress test...
