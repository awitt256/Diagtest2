...
-#>
    ...
    if ($ShowPolicies) {
        Write-Host " "
        Write-Output "POLICIES PROCESSED" -ForegroundColor Magenta   
    ...
    if (Test-Path $path) {
        ...
        Write-Host " "
        Write-Output "DEVICE ESP:" -ForegroundColor Magenta
        Write-Host " "
    ...
    # Display timeline
    Write-Host ""
    Write-Output "OBSERVED TIMELINE:" -ForegroundColor Magenta
    Write-Host ""
