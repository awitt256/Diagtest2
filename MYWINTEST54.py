...
def show_hardware_test_screen():
    ...
    ram_speed_banner = _register_ctk_frame(
        ctk.CTkFrame(ram_content, height=36, fg_color=theme_value("embed_bg"), corner_radius=8))
    ...
    ram_timing_banner = _register_ctk_frame(
        ctk.CTkFrame(ram_content, height=36, fg_color=theme_value("embed_bg"), corner_radius=8))
    ...
    def _ram_refresh(auto_pass_fail=True):
        ...
        for idx, mod in enumerate(modules):
            ...
            speed = 0
            try:
                if mod["configured_speed"].isdigit() and int(mod["configured_speed"]) > 0:
                    speed = int(mod["configured_speed"])
                elif mod["speed"].isdigit():
                    speed = int(mod["speed"])
            except Exception:
                speed = 0
