...
def render_account_menu():
    ...
    add_button("Manage Users", lambda: run_cmd("start ms-settings:otherusers"))
    add_button("Delete User Account", lambda: run_tool("deleteaccount.bat"))
    add_button("Create Local Account", lambda: run_tool("account.bat"))
