...
def render_main_menu():
    global search_entry, _search_trace_id

    # Remove trace BEFORE destroying widgets so the dead CTkEntry
    # never receives a textvariable callback during teardown
    ...
    ctk.CTkLabel(
        title_frame,
        text="DTT v 0.083 Created By Anthony Witt 2026",
    ...
    ctk.CTkLabel(
        title_frame,
        text="Revision V0.83 Search feature works again and new system info version",
