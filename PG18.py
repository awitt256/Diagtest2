...
def open_system_info():
    ...
    def load_report():
        ...
        textbox.insert("1.0", generate_system_info_report())
        textbox.configure(state="disabled")
...
def render_main_menu():
    ...
    ctk.CTkLabel(
        title_frame,
        text="Revision V0.82 - Added back search and got system info working",
    ...
    search_entry = ctk.CTkEntry(
        search_frame,
        placeholder_text="Type to filter tools, like ssd, kb, disk health...",
        height=36
    )
