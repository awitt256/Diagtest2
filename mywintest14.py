...
def show_hardware_test_screen():
    ...
    ctk.CTkLabel(top_bar, text="Hardware Test Suite — Revision 0.13: PASS AND FAIL CHECKS AND TOUCHPAD TEST ADDED  ",
    ...
    try:
        tp_card.pack_configure(fill="both")
        tp_card.configure(height=740)
        tp_card.pack_propagate(False)
    except Exception:
        pass
    ...
    kb_embed_host.pack(fill="both", expand=True, padx=14, pady=(0, 4))
