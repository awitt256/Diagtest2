...
echo.
echo                 DIAGNOSTICS TEST TOOL V.61  - BUILT BY ANTHONY WITT 2026
timeout /t 3 >nul

:Menu
echo =================================================================================
echo                   DIAGNOSTICS TEST TOOL V.61 - BUILT BY ANTHONY WITT
echo ================================================================================
...
echo  23. Touchscreen Test       24. SSD Test
echo.
echo [ NETWORK ]
echo  25. Network Settings       26. Wi-Fi Info
echo.
echo [ SETTINGS / SECURITY ]
echo  27. Camera Settings       28. Activation Settings    29. Sound Settings
echo  30. Account Settings      31. Date/Time Settings     32. Language/Region
echo  33. Windows Defender      34. Check Windows Key
echo  35. Windows Version       36. Windows Update
echo.
echo [ DEPLOYMENT / TESTS ]
echo  37. Sysprep Options       38. Software Framework
echo.
echo [ UTILITIES ]
echo  39. Task Manager          40. Event Viewer           41. Clear Temp Files
echo.
echo [ POWER ]
echo  42. Restart               43. Shutdown               44. Exit
echo =================================================================================
set /p choice=Select an option (1-44): 
...
if "%choice%"=="15" (call "%~dp0AUDIOR.BAT" & goto Menu)
...
if "%choice%"=="22" (start USBTreeView.exe & goto Menu)
if "%choice%"=="23" goto TouchscreenTest
if "%choice%"=="24" goto ssd
if "%choice%"=="25" goto NetworkSettings
if "%choice%"=="26" (netsh wlan show interfaces & pause & goto Menu)
if "%choice%"=="27" goto CameraSettings
if "%choice%"=="28" goto ActivationSettings
if "%choice%"=="29" goto SoundSettings
if "%choice%"=="30" goto AccountMenu
if "%choice%"=="31" goto DateTimeSettings
if "%choice%"=="32" goto LanguageRegion
if "%choice%"=="33" goto Defender
if "%choice%"=="34" goto WinKey
if "%choice%"=="35" goto WindowsVersion
if "%choice%"=="36" goto WindowsUpdate
if "%choice%"=="37" goto Sysprep
if "%choice%"=="38" goto SF
if "%choice%"=="39" (start taskmgr & goto Menu)
if "%choice%"=="40" (start eventvwr.msc & goto Menu)
if "%choice%"=="41" (echo Cleaning Temp... & del /s /q %temp%\*.* >nul 2>&1 & del /s /q C:\Windows\Prefetch\*.* >nul 2>&1 & echo Done! & pause & goto Menu)
if "%choice%"=="42" goto Restart
if "%choice%"=="43" goto Shutdown
if "%choice%"=="44" goto End
goto Menu
...
:WindowsUpdate
echo =================================================================================
echo                  WINDOWS UPDATE / DRIVER MENU
echo =================================================================================
echo 1. Install ALL Windows updates (security + drivers)
echo 2. Install ONLY missing drivers
echo 3. Return to MAIN MENU
echo.
set /p wuChoice=Select an option (1-3): 

if "%wuChoice%"=="1" goto WindowsUpdate_All
if "%wuChoice%"=="2" call "%~dp0missdrivers.bat" & goto Menu
if "%wuChoice%"=="3" goto Menu
goto WindowsUpdate
