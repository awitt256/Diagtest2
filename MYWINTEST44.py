...
def show_hardware_test_screen():
    ...
    try:
        ...
        _register_title_label(ctk.CTkLabel(_comp_header_row, text="🧩  Components",
                     font=ctk.CTkFont(size=14, weight="bold"),
                     text_color="#58a6ff")).pack(side="left")
        try:
            _register_refresh_button(ctk.CTkButton(_comp_header_row, text="⟳", width=28, height=28, fg_color="#444444", hover_color="#555555", command=_start_system_info_once)).pack(side="right")
        except Exception:
            pass
    except Exception:
        pass
    ...
    try:
        ...
        _comp_grid = _register_tk_frame(tk.Frame(comp_frame, bg=theme_value("embed_bg")))
