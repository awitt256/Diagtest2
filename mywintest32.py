...
def show_hardware_test_screen():
    ...
    # Replace the Run button with a small retry icon (header already has a refresh)
    try:
        ctk.CTkButton(act_btn_row, text="⟳", width=34, height=34, fg_color="#444444",
                      hover_color="#555555", corner_radius=18,
                      font=ctk.CTkFont(size=14, weight="bold"), command=_run_activation_check).pack(side="left")
    except Exception:
        # Fallback: do nothing if CTkButton creation fails
        pass
