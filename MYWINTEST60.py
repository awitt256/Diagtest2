...
# Global placeholders for widgets and state used across the app
...
def show_hardware_test_screen():
    ...
    try:
        ...
        try:
            ctk.CTkButton(header_row, text="⟳", width=28, height=28, fg_color="#444444", hover_color="#555555",
                          command=lambda: _run_audiog_clicked()).pack(side="right")
        except Exception:
            pass
    except Exception:
        pass
    ...
    try:
        ...
        try:
            ctk.CTkButton(header_row, text="⟳", width=28, height=28, fg_color="#444444", hover_color="#555555",
                          command=lambda: _start_system_info_once()).pack(side="right")
        except Exception:
            pass
    except Exception:
        pass
    ...
    usb_start_btn = ctk.CTkButton(
        ...
        fg_color="#2ecc71",
        hover_color="#3ae083",
        command=lambda: _start_port_testing()
    )
    ...
    usb_pass_btn = ctk.CTkButton(
        ...
        hover_color="#3ae083",
        state="disabled",
        command=lambda: _mark_port_passed()
    )
