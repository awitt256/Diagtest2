    ...
    $featureDefinitions = @(
        ...
        [pscustomobject]@{
            ...
            DeviceCheck = {
                param($Devices)
                $Devices | Where-Object {
                    $_.ClassName -eq "Biometric" -and
                    $_.DeviceDescription -notmatch '(?i)hello|face|facial|iris|infrared|ir camera|ircamera'
                } | Select-Object -First 1
            }
        }
        [pscustomobject]@{
            ...
            'FINGERPRINT' {
                if (
                    ...
                    (
                        ...
                        $normalized -notmatch '(?i)windowshello|windows hello|hello|face|facial|iris|infrared|ir camera|ircamera'
                    )
                ) {
                    return [pscustomobject]@{
                        Present = $true
