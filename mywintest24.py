...
def show_hardware_test_screen():
    ...
    ctk.CTkLabel(top_bar, text="Hardware Test Suite — Revision 0.24: ADDED NEW PASS FAIL CHECKS + BETTER CAMERA SUPPORT,MINOR MODULE TWEAKS",
    ...
    try:
        ...
        try:
            ctk.CTkButton(header_row, text="⟳", width=28, height=28, fg_color="#444444", hover_color="#555555", command=_spk_play).pack(side="right")
        except Exception:
            pass
    except Exception:
        pass
    ...
    try:
        ...
        try:
            ctk.CTkButton(header_row, text="⟳", width=28, height=28, fg_color="#444444", hover_color="#555555", command=show_mic_tester).pack(side="right")
        except Exception:
            pass
    except Exception:
        pass
    ...
    try:
        ...
        try:
            ctk.CTkButton(header_row, text="⟳", width=28, height=28, fg_color="#444444", hover_color="#555555", command=show_keyboard_tester).pack(side="right")
        except Exception:
            pass
    except Exception:
        pass
    ...
    try:
        ...
        try:
            ctk.CTkButton(header_row, text="⟳", width=28, height=28, fg_color="#444444", hover_color="#555555", command=_run_activation_check).pack(side="right")
        except Exception:
            pass
    except Exception:
        pass
