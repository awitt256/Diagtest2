...
def show_hardware_test_screen():
    ...
    ctk.CTkLabel(
        top_bar,
        text="Hardware Test Suite — Revision 0.42  Added enrollment test and computrace check refined pdf ",
    ...
    # Start the timer when test suite starts
    start_timer()
    ...
    def _net_refresh():
        try:
            ...
            def _apply():
                ...
                try:
                    if total_count > 0 and hasattr(net_card, "set_pass"):
                        net_card.set_pass()
                except Exception:
                    pass
    ...
    def _fingerprint_refresh():
        ...
        try:
            ...
            for line in out.split('\n'):
                ...
                elif line.startswith("TOTAL_BIOMETRIC_DEVICES:"): bio = int(line.split(":", 1)[1].strip())
                elif line.startswith("FINGERPRINT_READERS:"): fp_r = int(line.split(":", 1)[1].strip())
                elif line.startswith("WORKING_FINGERPRINT_DEVICES:"): wrk = int(line.split(":", 1)[1].strip())
